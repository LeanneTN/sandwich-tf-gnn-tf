...
from component.inputters.constants import BOS_WORD, EOS_WORD, PAD_WORD, \
    UNK_WORD, CLS_WORD, TOKEN_TYPE_MAP, AST_TYPE_MAP, DATA_LANG_MAP, LANG_ID_MAP, NODE_TYPE_MAP
...
def making_dicts(exs,args):
    if not os.path.exists(args.dicts):
        ...
        for ex_dict in exs:
            ...
            for i in tqdm(ex_dict['reses'], ncols=150):
                for split in i['text']:
                    for tk in split:
    ...
    return dictionary_attr,dictionary_type,dictionary_token
