...
def add_train_args(parser):
    ...
    files.add_argument('--test_dataset', type=str, default="/root/CCSG/data/data_cache/eval_java_construct.pkl",
                       help='the dir of dataset')
    ...
    general.add_argument('--use_cuda', type='bool', default=True,
...
def init_from_scratch(args, vocabs):
    ...
    model = CCSGModel(config.get_model_args(args), vocabs)
